...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var defaultList:Array<Array<String>> = [ //Name - Icon name - Description - Link - BG Color
			['Developer Team'],
			['CherryMix',		'cherry',		'Director/Musician',			'https://twitter.com/Cherryiscoolbro',		 '9B0E8B'],
			['TINKATONK',		'tinkatonk',	"Programming",					'https://www.youtube.com/channel/UCcmSo3U6ob1C04bPz2wSNtQ',	 'B16B49'],
			['ShultzyNG',		'shultz',		'Artist',						'https://twitter.com/ShultzNG',		 'B443FE'],
			['Jester',			'jester',		'Artist',						'https://twitter.com/Zyhapo',		 'FF1200'],
			['The Raimbow',		'jester',		'Charter, and yes it is spelt that way.',						'https://twitter.com/raimbowcore12',		 'FF1200'],
			['Psych Engine Team'],
